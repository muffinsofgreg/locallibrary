...
class Book(models.Model):
    ...
    # Foreign key used because book can have only one author, but authors can
    # have multiple books
    # Author as a string rather than an object because it hasn't been declared
    # yet in the file.
    ...
    def get_absolute_url(self):
        """
        returns URL access to a detail record for this book.
        """
